/****************************************************************************
** Meta object code from reading C++ file 'texture.hpp'
**
...
#include "../face-recognition/texture.hpp"
#include <QtCore/qbytearray.h>
#include <QtCore/qmetatype.h>
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'texture.hpp' doesn't include <QObject>."
...
const QMetaObject Texture::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_Texture.data,
      qt_meta_data_Texture,  qt_static_metacall, nullptr, nullptr}
};
