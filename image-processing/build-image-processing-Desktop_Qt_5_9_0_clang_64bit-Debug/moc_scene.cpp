...
#include "../image-processing/scene.h"
...
QT_MOC_LITERAL(1, 6, 16), // "slot_updateScene"
QT_MOC_LITERAL(2, 23, 0) // ""

    },
    "Scene\0slot_updateScene\0"
};
...
void Scene::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->slot_updateScene(); break;
        default: ;
        }
    }
    Q_UNUSED(_a);
...
void *Scene::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, "QGLFunctions"))
        return static_cast< QGLFunctions*>(const_cast< Scene*>(this));
